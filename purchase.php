...
<head>
    ...
    <title>ED Warehouse - Purchase</title>
...
<section class="grid-container">
    <div class="navbar-container">
        <button class="home-btn login-btn">HOME</button>
    ...
    <div class="main-container">
        <h1><span class="energy-span"></span></br><span class="warehouse-span">Purchase</span></h1>
    </div>
</section>
</body>
</html>