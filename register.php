...
<section class="grid-container">
    ...
    <div class="login-container">
        <form method="POST" action="php/handleRegister.php">
            ...
            <span title="Name"><svg xmlns= "http://www.w3.org/2000/svg" class="h-6 w-6 user-icon-register ed-name" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm0 0c1.306 0 2.417.835 2.83 2M9 14a3.001 3.001 0 00-2.83 2M15 11h3m-3 4h2" />
                </svg></span>
            <input type="text" id="pName" placeholder="Name" name="pName" required>
            <span title="Surname"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 user-icon-register ed-surname" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm0 0c1.306 0 2.417.835 2.83 2M9 14a3.001 3.001 0 00-2.83 2M15 11h3m-3 4h2" />
                </svg></span>
            <input type="text" id="pSurname" placeholder="Surname" name="pSurname" required>
            <span title="Password">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 password-icon-register" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
